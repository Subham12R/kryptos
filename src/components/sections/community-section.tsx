          ...
          <div className="relative flex flex-col gap-7 sm:flex-row sm:items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-8">
                <Link
                  href="#extension"
                  className="inline-flex items-center gap-2 rounded-full px-6 py-3 font-array text-sm tracking-tight text-black transition-all duration-300 hover:opacity-85 hover:shadow-[0_0_20px_rgba(0,255,148,0.3)]"
