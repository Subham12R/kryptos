...
export type RiskLabel = "Low Risk" | "Medium Risk" | "High Risk" | "Critical Risk" | "Unknown" | "No Data"
...
export function mapBackendRiskLabel(label: string): "LOW" | "MEDIUM" | "HIGH" | "CRITICAL" {
  const lowerLabel = label.toLowerCase()
  if (lowerLabel.includes("critical") || lowerLabel.includes("high")) return "HIGH"
  if (lowerLabel.includes("medium") || lowerLabel.includes("medium risk")) return "MEDIUM"
